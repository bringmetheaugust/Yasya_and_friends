...
module.exports = {
	...
	raya: {
		...
		notification: `Уважаемая Раиса Александровна.<br/> Мы получили Ваши замечания
			и обязательно сосредоточим все усилия, чтобы исправить все неполадки.
			Спасибо, что остаетесь с нами. <br />В качестве компенсации за все неудобства,
			мы заменили Вам фрутоняню.`,
	},
	megija: {
		id: 10,
		gameType: HUNGRY_GAME_TYPE,
